...
public class StockSymbols {
	...
	public static String BAJAJ_FINANCE = "BAJFINANCE";

	public static String SRIRAM_TRANSPORTATION_FINANCE = "SRTRANSFIN";
	...
	public static String AXIS_BANK = "AXISBANK";

	public static String ICICI_BANK = "ICICIBANK";
