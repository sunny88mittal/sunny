...
import Zerodha.Trader.Strategy.ShortStrangleWithFixedStopLoss;
...
public class MainApp {
	...
	public static void main(String args[])
		...
		IStrategy strategy = new ShortStrangleWithFixedStopLoss(AppConstants.OPTION_DATE_VALUE, kiteUsers);
		strategy.initialize();
